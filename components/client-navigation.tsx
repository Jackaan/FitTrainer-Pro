...
import { Dumbbell, Calendar, History, User, LogOut, Menu, X } from "lucide-react"
...
export function ClientNavigation() {
  ...
  const navItems = [
    { href: "/client/dashboard", label: "Dashboard", icon: Dumbbell },
    { href: "/client/workouts", label: "Current Workout", icon: Calendar },
